...
public class Ejercicio8 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Ingresar apellido paterno del Alumno a buscar:  ");
        String buscarapellidopaterno = scanner.nextLine();

        System.out.print("Ingresar apellido materno del Alumno a buscar:  ");
        String buscarapellidomaterno = scanner.nextLine();

        for (Alumno alumno : alumnos) {
            if (alumno.getApellidopaterno().equals(buscarapellidopaterno) | alumno.getApellidopaterno().equals(buscarapellidopaterno)) {
                System.out.println("Nombre:  " + alumno.getNombre());
                System.out.println("Apellido: " + alumno.getApellidopaterno());
